...
namespace Semantic.WebApp.Plugins
{
    public class GetWeather
    {
        ...
        [return: Description("returns the 7 day forecast in 12 hour increments, formatted as Digital Weather Markup Language (DWML)")]
        public async Task<string> GetWeatherPointAsync(decimal latitude, decimal longitude)
        {
            ...
            request.Headers.Add("User-Agent", "semantic-webapp-udemy-course");
